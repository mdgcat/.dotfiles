...
function doIt() {
    exclude_list="setup.sh .git .gitmodules .DS_store bootstrap.sh README.md .gitconfig .osx .path .wgetrc .vim more_python.txt requirements.txt tmux-powerline .brew .functions .gitignore"
